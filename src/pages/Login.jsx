                    ...
                    <div className="w-1/2 bg-gradient-to-br from-blue-500 via-blue-600 to-blue-700 flex flex-col items-center justify-center p-8 lg:p-12">
                        ...
                        <div className="text-center text-white space-y-4">
                            ...
                            <p className="text-blue-100 text-lg max-w-md">
                                Sign in to your account and continue your journey with us. Access your dashboard and manage your agricultural business.
                            </p>
                        </div>
                        ...
                        <div className="w-full max-w-md bg-white py-4">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                {/* <div className="grid grid-cols-2 gap-4">
                                    <button
                                        type="button"
                                        className="flex items-center justify-center gap-2 px-4 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition-all duration-200 hover:shadow-md group"
                                    >
                                ...
                                <div className="mt-8 p-4 bg-blue-50 rounded-lg border border-blue-100">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <p className="text-sm text-blue-800">
                                            <span className="font-semibold">Need help?</span> Contact our support team at support@harvesthub.com
                                        </p>
                                    </div>
                                </div>
                            </form>
