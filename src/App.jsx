...
const FAQManagement = lazy(() => import("./pages/FAQ/FAQManagement"));
              ...
              <MainLayout>
                ...
                >
                  <Routes>
                    ...
                    <Route path="/coupons/create" element={<CouponManager />} />
                    <Route path="/coupons/edit/:id" element={<CouponManager />} />
